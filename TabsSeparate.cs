    ...
    public partial class TabsSeparate : Form
    {
                ...
                case Province.Variable.Revolt:
                    {
                        ...
                        cb.Items.AddRange(GlobalVariables.RebelTypes.ToArray());
                        cb.Size = new Size(133, 21);
                        cb.Location = new Point(60, 19);                       
                        cb.SelectedItem = ((ProvinceDateEntry.Revolt)(entry.Value)).Type;
        ...
        public void UpdateDateEntriesPage()
        {
            ...
            if (GlobalVariables.ClickedProvinces.Count > 0)
            {
                ...
                if (SelectedDateEntry != null && !DateEntrySelectionBox.Items.Contains(SelectedDateEntry))
                {
                    SelectedDateEntry = null;
                }
                else
                {
                    DateEntrySelectionBox.SelectedItem = SelectedDateEntry;
                }
        ...
        public void UpdateChangesTab()
        {
            ...
            foreach (VariableChange change in GlobalVariables.Changes)
            {
                ...
                varlab.Text = "Variable: " + change.GetVariableName();
                ...
                if (change.SpecialChange == VariableChange.NonVariableChange.OwnerTag || change.SpecialChange == VariableChange.NonVariableChange.ControllerTag ||
                    change.SpecialChange == VariableChange.NonVariableChange.DiscoveredByTag || change.SpecialChange == VariableChange.NonVariableChange.CoreTag ||
                    change.SpecialChange == VariableChange.NonVariableChange.ClaimTag)
        ...
        private void CreateCountryButton_Click(object sender, EventArgs e)
        {
            ...
            if (!countryForm.Canceled)
            {
                ...
                NodeFile history = new NodeFile(GlobalVariables.pathtomod + "history\\countries\\" + countryForm.CTag + " - " + countryForm.CName + ".txt");
                c.HistoryFile = history;
                NodeFile common = new NodeFile(GlobalVariables.pathtomod + "common\\countries\\" + countryForm.CName + ".txt");
                c.CommonFile = common;
                ...
                GlobalVariables.ModCountryTagsFiles[0].MainNode.AddVariable(countryForm.CTag, $"\"countries/{countryForm.CName}.txt\"");
        ...
        private void RevertAllChangesButton_Click(object sender, EventArgs e)
        {
            ...
            foreach (VariableChange vc in GlobalVariables.Changes)
            {
                ...
                {
                    (vc.Object as Province).Variables[(vc as ProvinceVariableChange).ProvinceVariable] = vc.PreviousValue;
                }
                else if (vc.Object is Country)
                {
                    (vc.Object as Country).Variables[(vc as CountryVariableChange).CountryVariable] = vc.PreviousValue;
                }
        ...
        public void MergeChanges()
        {
            ...
            foreach (VariableChange change in GlobalVariables.Changes)
            {
                if (change.GetEnumInt() == 0 || change.GetEnumInt() == 21 || change.GetEnumInt() == 25 || change.GetEnumInt() == 3)
                {
                    newList.Add(change);
                    continue;
                }
        ...
        public void Revert(object sender, EventArgs e)
        {
            ...
            if (vc.Object is Province)
            {
                ...
                switch (vc.GetEnumInt())
                {
                    case (int)Province.Variable.Cores:
                        ...
                        break;
                    case (int)Province.Variable.DiscoveredBy:
                        if (vc.PreviousValue == null)
                        ...
                        break;
                    case (int)Province.Variable.Buildings:
                        if (vc.PreviousValue == null)
                        ...
                        break;
                    case (int)Province.Variable.Claims:
                    ...
                    case (int)Province.Variable.OwnerCountry:
                        if (GlobalVariables.mapmode == MapManagement.UpdateMapOptions.Political)
                        {
                        ...
                        break;
                    case (int)Province.Variable.Tax:
                        ...
                        break;
                    case (int)Province.Variable.Production:
                        ...
                        break;
                    case (int)Province.Variable.Manpower:
                        ...
                        break;
                    case (int)Province.Variable.CenterOfTrade:
                        ...
                        break;
                    case (int)Province.Variable.HRE:
                        ...
                        break;
                    case (int)Province.Variable.TradeGood:
                        ...
                        break;
                    case (int)Province.Variable.LatentTradeGood:
                    ...
                    case (int)Province.Variable.TradeNode:
                        ...
                        break;
                    case (int)Province.Variable.Religion:
                        ...
                        break;
                    case (int)Province.Variable.Culture:
                    ...
                    case (int)Province.Variable.Continent:
                        ...
                        break;
                    case (int)Province.Variable.TradeCompany:
                        ...
                        break;
                    case (int)Province.Variable.Winter:
                        ...
                        break;
                    case (int)Province.Variable.Climate:
                        ...
                        break;
                    case (int)Province.Variable.Terrain:
                        ...
                        break;
                    case (int)Province.Variable.Impassable:
                        ...
                        break;
                    case (int)Province.Variable.Monsoon:
                    ...
                    default:
                        ...
                        revProv.Variables[(Province.Variable)vc.GetEnumInt()] = vc.PreviousValue;
                        break;
                }
            }
            else if (vc.Object is Country)
            {
                (vc.Object as Country).Variables[(Country.Variable)vc.GetEnumInt()] = vc.PreviousValue;
            }
            GlobalVariables.Changes.Remove(vc);
            UpdateChangesTab();
            UpdateSavesTab();
                                    ...
                                    if (GlobalVariables.Countries.Any(x => x.Tag != CountryTagBox.Text))
                                    {
                                        ...
                                        foreach (Province p in GlobalVariables.Provinces)
                                        {
                                            if (p.OwnerCountry == GlobalVariables.SelectedCountry)
                                                GlobalVariables.Changes.Add(new VariableChange(p, VariableChange.NonVariableChange.OwnerTag, oldtag, newtag));
                                            else if (p.Controller == GlobalVariables.SelectedCountry)
                                                GlobalVariables.Changes.Add(new VariableChange(p, VariableChange.NonVariableChange.ControllerTag, oldtag, newtag));
                                            else if (p.GetDiscoveredBy().Contains(GlobalVariables.SelectedCountry.Tag))
                                            {
                                                ...
                                                GlobalVariables.Changes.Add(new VariableChange(p, VariableChange.NonVariableChange.DiscoveredByTag, oldtag, newtag));
                                            }
                                            else if (p.GetCores().Contains(GlobalVariables.SelectedCountry.Tag))
                                            {
                                                ...
                                                GlobalVariables.Changes.Add(new VariableChange(p, VariableChange.NonVariableChange.CoreTag, oldtag, newtag));
                                            }
                                            else if (p.GetClaims().Contains(GlobalVariables.SelectedCountry.Tag))
                                            {
                                                ...
                                                GlobalVariables.Changes.Add(new VariableChange(p, VariableChange.NonVariableChange.ClaimTag, oldtag, newtag));
                                            }
                                        }
                                        CountryTagBox.Text = GlobalVariables.SelectedCountry.Tag;
                                    }
